...
# The article is a json file that contains the title, the content and the author of the article
...
multichain-cli wikichain publish wikichain $title $content $author
